 ...
 * @author ""
 */
public class ProdutoDao_bbd extends DAO_Abstract {
    ...
    public List listAll() {
     ...
     public Object listNome(String nome) {
        ...
        Criteria criteria = session.createCriteria(ProdutoBbd.class); //o criteria é pedir pro hibernate criar um select chamando a tabela 
