...
public class JDlgConsultasFornecedor extends javax.swing.JDialog {
    ...
    public JDlgConsultasFornecedor(java.awt.Frame parent, boolean modal) {
        ...
        pesquisarFornecedor = new FornecedorControle();
    ...
    private void jBtnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnPesquisarActionPerformed
        ...
        if (jTxtTitulo_bbd.getText().equals("") && jTxtValor_bbd.getText().equals("")) {
            lista = (ArrayList) fornecedorDao_bbd.listAll();
            pesquisarFornecedor.setList(lista);
        } else {
            if ((!jTxtTitulo_bbd.getText().equals("")) && (!jTxtValor_bbd.getText().equals(""))) {
                lista = (ArrayList) fornecedorDao_bbd.listNomeValor(jTxtTitulo_bbd.getText(), Double.valueOf(jTxtValor_bbd.getText()));
                pesquisarFornecedor.setList(lista);
            } else {
                if (!jTxtTitulo_bbd.getText().equals("")) {
                    lista = (ArrayList) fornecedorDao_bbd.listNome(jTxtTitulo_bbd.getText());
                    pesquisarFornecedor.setList(lista);
                } else {
                    lista = (ArrayList) fornecedorDao_bbd.listValor(Double.valueOf(jTxtValor_bbd.getText()));
                    pesquisarFornecedor.setList(lista);
                }
            }
        }
